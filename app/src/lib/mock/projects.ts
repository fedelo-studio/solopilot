...
const seed: Project[] = [
  {
    ...
    description: "Repositionnement de marque complet : identité, guide de style, déclinaisons.",
    status: "active",
    soldBudget: 22_000,
  ...
  },
  {
    ...
    description: "Refonte du site institutionnel : UX, design, développement front, CMS.",
    status: "active",
    soldBudget: 17_500,
